...
var keyJson = [ {"no":0, "key": 'sinus rhythm', "score": 0},
                ...
                {"no":4, "key": 'AVW or 3rd AVB', "score": 2},
                ...
                {"no":7, "key": 'Artifact/Interference', "score": 2},
                {"no":7, "key": 'Parkinsonism', "score": 1},
                {"no":7, "key": 'Sinus rhythm', "score": 2},
                {"no":7, "key": 'Rate 70', "score": 1},
                {"no":7, "key": 'non-conducted PAC', "score": 3},
                {"no":7, "key": 'PAC w/ aberrancy', "score": 1},
                {"no":8, "key": 'Regular', "score": 1},
                {"no":8, "key": 'WCT', "score": 1},
                {"no":8, "key": 'Rate 160-180', "score": 1},
                {"no":8, "key": 'Superior Axis', "score": 1},
                {"no":8, "key": 'NO AV dissociation', "score": 2},
                {"no":8, "key": 'VT', "score": 1},
                {"no":8, "key": 'A-AVRT', "score": 2},
                {"no":8, "key": 'Right P/W', "score": 1},
                {"no":9, "key": 'AF', "score": 1},
                {"no":9, "key": 'w/RVR', "score": 1},
                {"no":9, "key": 'ST Elevation V1', "score": 2},
                {"no":9, "key": 'ST Elevation aVR', "score": 2},
                {"no":9, "key": 'ST Depression inf/lat', "score": 1},
                {"no":9, "key": 'Poor R progression', "score": 1},
                {"no":9, "key": 'Left Main Disease', "score": 2},
                {"no":10, "key": 'AP w/o capture', "score": 1},   
                {"no":10, "key": 'VP w/o capture', "score": 1},   
                {"no":10, "key": 'Appropriate VS', "score": 1},   
                {"no":10, "key": 'Sinus arrest', "score": 1},   
                {"no":10, "key": 'Wide QRS, near-fused QRST', "score": 3},
                {"no":10, "key": 'Hyperkalemia', "score": 3},
                {"no":11, "key": 'AT', "score": 1},
                {"no":11, "key": 'Rate 300', "score": 1},
                {"no":11, "key": '2-level of block', "score": 2},
                {"no":11, "key": '2:1 upper block, 3:2 lower block', "score": 2},
                {"no":11, "key": 'intermittent RBBB', "score": 1},
                {"no":11, "key": 'Ashman', "score": 2},
                {"no":11, "key": 'LVH', "score": 1},
                {"no":12, "key": 'Sinus rhythm', "score": 1},  
                {"no":12, "key": 'AV dissociation', "score": 2},            
                {"no":12, "key": 'initial R in aVR during tachycardia', "score": 2},
                {"no":12, "key": 'VT', "score": 2},
                {"no":12, "key": 'Poor R', "score": 1},
                {"no":12, "key": 'capture beat', "score": 1},
                {"no":12, "key": 'fusion beat', "score": 1},
            ]
