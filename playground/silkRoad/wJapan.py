...
# SPLIT COLORS
LAND_ROUTE_COLOR = '#FFE900'  # Neon Yellow (Land)
SEA_ROUTE_COLOR = '#00FFFF'   # Cyan (Sea)
CITY_COLOR = '#FFD700'      
TEXT_COLOR = '#FFFACD'      
...
# Maritime Routes (Cyan)
routes_sea = [
    # Main Sea Route
    {"path": [(118.0, 24.5), SHANGHAI, (125.0, 28.0), (113.2, 23.1), (109.0, 13.0), (104.0, 1.3), (95.0, 5.5), (80.0, 6.0), (75.0, 10.0), (65.0, 15.0), (50.0, 13.0), (43.0, 12.5), MAKKAH, (35.0, 25.0), ALEXANDRIA], "score": 0.8},
    # NEW: Shanghai to Japan Extension
    {"path": [SHANGHAI, (125.5, 30.5), (129.0, 31.5), (133.0, 33.5), NARA], "score": 0.6}
]
...
sea_x, sea_y = generate_dots(routes_sea, base_dots=3500)
...
# EXPANDED LIMITS FOR JAPAN
ax.set_xlim(0, 155)  # Expanded from 140 to 155 to show all of Japan
ax.set_ylim(-5, 60)
ax.set_aspect('equal')
ax.axis('off')
...
labels = {
    ...
    "Makkah": MAKKAH, "Alexandria": ALEXANDRIA, "Kyoto": KYOTO, "Nara": NARA,
...
for name, coords in labels.items():
    ...
    # Optional Text Labels (commented out in your previous request, uncomment if needed)
    y_off = -3.5
    if name in ["Singapore", "Constantinople", "Samarkand", "Rayy", "Kyoto", "Shanghai", "Seoul", "Taxila", "Nara"]: y_off = 3.5
    #ax.text(coords[0], coords[1]+y_off, name, color=TEXT_COLOR, fontsize=13, fontweight='bold', ha='center', zorder=10)

plt.tight_layout()
output_file = "playground/silkRoad/silk_road_japan_extended.png"
plt.savefig(output_file, dpi=300, facecolor=BG_COLOR)
print(f"✅ Map extended to Japan saved to: {output_file}")
plt.show()