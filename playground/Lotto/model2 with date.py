...
class DateIncorporatedLotteryPredictor:
    ...
    def predict(self, recent_data, recent_dates):
        ...
        combined_features = np.column_stack((scaled_numbers, scaled_dates))
...
def main():
    ...
    try:
        ...
        predicted_number = predictor.predict(recent_data, recent_dates)
