...
class LotteryNumberPredictor:
    ...
    def train(self, X, y, epochs=50, batch_size=16, validation_split=0.2):
        """
...
def main():
    CSV_PATH = 'playground\Lotto\lotterySince2015.csv'
    ...
    try:
        ...
        history = predictor.train(X_train, y_train, epochs=50, batch_size=16)
