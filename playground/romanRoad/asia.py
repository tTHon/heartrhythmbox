...
# --- MANUAL CROP FOR EURASIA ---
# Coordinates in EPSG:3857 (Web Mercator Meters)
# West: -15° (Portugal/Atlantic)  ~ -1,600,000m
# East: 140° (Japan/Korea)        ~ 15,500,000m
# South: 10° (Vietnam/India tip)  ~ 1,100,000m
# North: 60° (Scandinavia/Russia) ~ 8,400,000m
# West: -6,000,000 (Deep Atlantic)

ax.set_xlim(-4000000, 12000000)
ax.set_ylim(1100000, 8400000)
ax.set_axis_off()

plt.savefig("playground/romanRoad/Roman_Network_EuraAsia.png", facecolor=SEA_COLOR, dpi=300, bbox_inches='tight')
