...
categorical_vars = ["Sex", "MI","PCI/CABG","CHF","PAD","CVA","Dementia","COPD","CNT","PU","Liver","DM","CKD","Malignancy","TV","SigValve","AF","HTN","CCISev","Antiplatelet","OAC","IndicationPPM","IndicationforMicra","Access","Position","Model","Hemostasis"] 

#categorical_vars = ["CKD","CCISev","DM"] 
# Overall
summary_all = {}
