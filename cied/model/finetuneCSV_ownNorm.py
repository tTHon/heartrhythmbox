...
def get_dataset_stats(loader):
    """Calculates the mean and std of the dataset provided by the loader."""
...
def get_dataloaders(csv_path: str, img_dir: str,
    ...
    # Base transform to convert to tensor (values 0-1)
...
def main():
    ...
    parser.add_argument("--calc_stats", action="store_true",
                        help="Calculate dataset mean/std from training data (overrides ImageNet stats)")
