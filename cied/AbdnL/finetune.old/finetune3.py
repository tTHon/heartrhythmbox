...
Class mapping:
    ...
    x = Heart Monitor / ICM -- removed from this dataset
    2 = Active Lead 
    3 = Abandoned Lead (เป้าหมายหลัก)
"""
#developed from AbdnLeadTuning.py
...
def build_dataframe(args):
    ...
    # Oversampling Abandoned Lead (Class 3)
...
def dice_abandoned(inp, targ, eps=1e-6):
    """Dice score เฉพาะ class 3 (abandoned_lead)"""
