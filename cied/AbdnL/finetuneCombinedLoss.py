...
if __name__ == "__main__":
    ...
    parser.add_argument("--epochs_full",    type=int,   default=8)  # Phase 2: full fine-tuning — may need more epochs with smaller learning rate for stable convergence on this small dataset
    # learning rates   
